...
from stackforce_simready_cod_2026robomaster_balance_closed_usd_closed_usd_lab.tasks.direct.cod_2026robomaster_balance_closed_usd.cod_2026robomaster_balance_closed_usd_env_cfg import USD_PATH
